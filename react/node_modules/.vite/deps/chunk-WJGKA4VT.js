import {
  require_react_dom
} from "./chunk-7MAUIZKD.js";
import {
  __rest
} from "./chunk-22X72WGU.js";
import {
  require_jsx_runtime
...
function useCreateMotionContext(props) {
  const { initial, animate: animate4 } = getCurrentTreeVariants(props, (0, import_react11.useContext)(MotionContext));
  return (0, import_react11.useMemo)(() => ({ initial, animate: animate4 }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate4)]);
}
...
var VisualElementHandler = class extends import_react14.default.Component {
  /**
...
function createMotionComponent({ preloadedFeatures, createVisualElement, projectionNodeConstructor, useRender, useVisualState: useVisualState2, Component: Component2 }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    if (!isStatic && isBrowser) {
      ...
      const lazyStrictMode = (0, import_react16.useContext)(LazyContext).strict;
...
function buildHTMLStyles(state2, latestValues, options, transformTemplate2) {
  const { style: style2, vars: vars2, transform: transform3, transformKeys: transformKeys2, transformOrigin } = state2;
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, projectionId, ref, { latestValues }, isStatic) => {
    ...
    return (0, import_react19.createElement)(Component2, {
      ...elementProps,
...
function useHoverGesture({ onHoverStart, onHoverEnd, whileHover, visualElement }) {
  usePointerEvent(visualElement, "pointerenter", (0, import_react23.useMemo)(() => {
  ...
  usePointerEvent(visualElement, "pointerleave", (0, import_react23.useMemo)(() => {
...
function useTapGesture({ onTap, onTapStart, onTapCancel, whileTap, visualElement, ...props }) {
  ...
  const isPressing = (0, import_react25.useRef)(false);
  const cancelPointerEndListeners = (0, import_react25.useRef)(null);
  const eventOptions = {
  ...
  function onPointerUp(event, info) {
    ...
    if (!checkPointerEnd())
      return;
    !isNodeOrChild(visualElement.current, event.target) ? (_b5 = (_a7 = visualElement.getProps()).onTapCancel) === null || _b5 === void 0 ? void 0 : _b5.call(_a7, event, info) : (_d3 = (_c3 = visualElement.getProps()).onTap) === null || _d3 === void 0 ? void 0 : _d3.call(_c3, event, info);
  }
  function onPointerCancel(event, info) {
    var _a7, _b5;
    if (!checkPointerEnd())
      return;
    (_b5 = (_a7 = visualElement.getProps()).onTapCancel) === null || _b5 === void 0 ? void 0 : _b5.call(_a7, event, info);
  }
  const startPress = (0, import_react25.useCallback)((event, info) => {
    var _a7;
    removePointerEndListener();
    ...
    (_a7 = latestProps.onTapStart) === null || _a7 === void 0 ? void 0 : _a7.call(latestProps, event, info);
...
function useViewport({ visualElement, whileInView, onViewportEnter, onViewportLeave, viewport = {} }) {
  const state2 = (0, import_react26.useRef)({
...
var animations = {
  animation: makeRenderlessComponent(({ visualElement, animate: animate4 }) => {
    ...
    if (isAnimationControls(animate4)) {
      (0, import_react28.useEffect)(() => animate4.subscribe(visualElement), [animate4]);
    }
  }),
...
function useDrag(props) {
  ...
  (0, import_react29.useEffect)(() => groupDragControls && groupDragControls.subscribe(dragControls), [dragControls, groupDragControls]);
  (0, import_react29.useEffect)(() => dragControls.addListeners(), [dragControls]);
}
...
function usePanGesture({ onPan, onPanStart, onPanEnd, onPanSessionStart, visualElement }) {
  ...
  const panSession = (0, import_react30.useRef)(null);
  const { transformPagePoint } = (0, import_react30.useContext)(MotionConfigContext);
  const handlers = {
  ...
  loadFeatures({ children, ...renderedProps }, isStrict, preloadedFeatures, projectionId, ProjectionNodeConstructor, initialLayoutGroupConfig) {
    ...
    for (let i = 0; i < numFeatures; i++) {
      ...
      if (isEnabled(renderedProps) && Component2) {
        features.push((0, import_react31.createElement)(Component2, {
          key: name,
          ...renderedProps,
          visualElement: this
        }));
...
// node_modules/framer-motion/dist/es/motion/features/layout/MeasureLayout.mjs
var MeasureLayoutWithContext = class extends import_react32.default.Component {
  /**
...
function MeasureLayout(props) {
  const [isPresent2, safeToRemove] = usePresence();
  const layoutGroup = (0, import_react32.useContext)(LayoutGroupContext);
  return import_react32.default.createElement(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react32.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
function createProjectionNode({ attachResizeListener, defaultParent, measureScroll, checkIsScrollRoot, resetTransform }) {
  return class ProjectionNode {
    ...
    getTransformTemplate() {
      var _a7;
      return (_a7 = this.options.visualElement) === null || _a7 === void 0 ? void 0 : _a7.getProps().transformTemplate;
    }
    ...
    resetTransform() {
      ...
      const transformTemplateValue = (_a7 = this.getTransformTemplate()) === null || _a7 === void 0 ? void 0 : _a7(this.latestValues, "");
...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react34.useState)(0);
  const forceRender = (0, import_react34.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react34.useCallback)(() => sync.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  const size2 = (0, import_react35.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode: mode2 = "sync" }) => {
  ...
  const forceRenderLayoutGroup = (0, import_react37.useContext)(LayoutGroupContext).forceRender;
  ...
  exiting.forEach((key) => {
    ...
    childrenToRender.splice(insertionIndex, 0, React4.createElement(PresenceChild, { key: getChildKey(child), isPresent: false, onExitComplete: onExit, custom, presenceAffectsLayout, mode: mode2 }, child));
  });
  childrenToRender = childrenToRender.map((child) => {
    const key = child.key;
    return exiting.has(key) ? child : React4.createElement(PresenceChild, { key: getChildKey(child), isPresent: true, presenceAffectsLayout, mode: mode2 }, child);
  });
  if (mode2 === "wait" && childrenToRender.length > 1) {
    console.warn(`You're attempting to animate multiple children within AnimatePresence, but its mode is set to "wait". This will lead to odd visual behaviour.`);
  }
  return React4.createElement(React4.Fragment, null, exiting.size ? childrenToRender : childrenToRender.map((child) => (0, import_react37.cloneElement)(child)));
};
...
var ReorderContext = (0, import_react42.createContext)(null);
...
function ReorderGroup({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const order2 = [];
  const isReordering = (0, import_react43.useRef)(false);
...
var Group = (0, import_react43.forwardRef)(ReorderGroup);
...
function ReorderItem({ children, style: style2 = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  ...
  const measuredLayout = (0, import_react45.useRef)(null);
...
var steps2 = (steps4, direction2 = "end") => (progress3) => {
...
function animateStyle2(element, key, keyframesDefinition, options = {}, AnimationPolyfill) {
  ...
  return () => {
    ...
    if (valueIsTransform && !supports2.linearEasing() && (isFunction2(easing) || isEasingList(easing) && easing.some(isFunction2))) {
      canAnimateNatively = false;
    }
    if (canAnimateNatively) {
      if (definition) {
        keyframes4 = keyframes4.map((value) => isNumber(value) ? definition.toDefaultUnit(value) : value);
      }
...
function resolveOption(option, i, total) {
  return isFunction2(option) ? option(i, total) : option;
}
...
var useInsertionEffect5 = React12["useInsertionEffect"] ? React12["useInsertionEffect"] : false;
var useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect5 || syncFallback;
var useInsertionEffectWithLayoutFallback = useInsertionEffect5 || React12.useLayoutEffect;
...
var withEmotionCache = function withEmotionCache2(func) {
  return (0, import_react57.forwardRef)(function(props, ref) {
    var cache = (0, import_react57.useContext)(EmotionCacheContext);
...
"use client";
function useTheme2() {
  const theme2 = (0, import_react59.useContext)(
    ThemeContext
  );
  if (!theme2) {
    throw Error(
...
"use client";
var ColorModeContext = (0, import_react60.createContext)({});
ColorModeContext.displayName = "ColorModeContext";
function useColorMode() {
  const context = (0, import_react60.useContext)(ColorModeContext);
  if (context === void 0) {
...
function ColorModeProvider(props) {
  ...
  const [colorMode, rawSetColorMode] = (0, import_react62.useState)(
    () => getTheme3(colorModeManager, defaultColorMode)
  );
  const [resolvedColorMode, setResolvedColorMode] = (0, import_react62.useState)(
    () => getTheme3(colorModeManager)
  );
  const { getSystemTheme, setClassName, setDataset, addListener } = (0, import_react62.useMemo)(
  ...
  const toggleColorMode = (0, import_react62.useCallback)(() => {
...
function parseGradient(value, theme2) {
  ...
  const results3 = regex.exec(value);
  const type = results3 == null ? void 0 : results3[1];
  const values = results3 == null ? void 0 : results3[2];
  if (!type || !values)
    return value;
...
var transformFunctions = {
  ...
  hueRotate: (value) => wrap3("hue-rotate")(transformFunctions.degree(value)),
  invert: wrap3("invert"),
...
function isCssVar22(value) {
  return /^var\(--.+\)$/.test(value);
}
var isCSSVariableTokenValue = (key, value) => key.startsWith("--") && typeof value === "string" && !isCssVar22(value);
...
var memoizedGet2 = memoize4(get2);
...
var pipe5 = (...fns) => (v) => fns.reduce((a, b) => b(a), v);
...
var flushSync2 = stepsOrder2.reduce((acc, key) => {
  acc[key] = () => steps3[key].process(frame);
  return acc;
}, {});
var processStep2 = (stepId) => steps3[stepId].process(frame);
var processFrame2 = (timestamp) => {
  runNextFrame2 = false;
  frame.delta = useDefaultElapsed2 ? defaultTimestep2 : Math.max(Math.min(timestamp - frame.timestamp, maxElapsed2), 1);
...
var PanSession2 = class {
  constructor(event, handlers, threshold) {
    ...
    __publicField(this, "removeListeners", noop4);
...
function useStyleConfigImpl(themeKey, props = {}) {
  ...
  const stylesRef = (0, import_react63.useRef)({});
  if (styleConfig) {
...
function styled(component, options) {
  ...
  const chakraComponent = import_react67.default.forwardRef(function ChakraComponent(props, ref) {
    const { colorMode, forced } = useColorMode();
    return import_react67.default.createElement(Component2, {
      ref,
...
function createContext11(options = {}) {
  ...
  const Context = (0, import_react70.createContext)(void 0);
  Context.displayName = name;
  function useContext24() {
    var _a7;
    const context = (0, import_react70.useContext)(Context);
    if (!context && strict) {
      const error2 = new Error(errorMessage);
      error2.name = "ContextError";
      (_a7 = Error.captureStackTrace) == null ? void 0 : _a7.call(Error, error2, useContext24);
      throw error2;
    }
    return context;
  }
...
function ThemeProvider3(props) {
  ...
  const computedTheme = (0, import_react72.useMemo)(() => toCSSVar(theme2), [theme2]);
...
var ToastComponent = (0, import_react74.memo)((props) => {
  const {
    id: id3,
    message,
    onCloseComplete,
  ...
  const [delay2, setDelay] = (0, import_react74.useState)(duration);
  ...
  const containerStyles = (0, import_react74.useMemo)(
    () => ({
      pointerEvents: "auto",
      maxWidth: 560,
      minWidth: 300,
  ...
  const toastStyle = (0, import_react74.useMemo)(() => getToastStyle(position3), [position3]);
...
function createIcon(options) {
  ...
  const path = import_react75.Children.toArray(options.path);
...
function createContext12(options = {}) {
  ...
  const Context = (0, import_react76.createContext)(defaultValue);
  Context.displayName = name;
  function useContext24() {
    var _a7;
...
var DefaultPortal = (props) => {
  ...
  const [tempNode, setTempNode] = (0, import_react77.useState)(null);
  const portal = (0, import_react77.useRef)(null);
  const [, forceUpdate] = (0, import_react77.useState)({});
  (0, import_react77.useEffect)(() => forceUpdate({}), []);
...
var ContainerPortal = (props) => {
  ...
  const portal = (0, import_react77.useMemo)(() => {
...
var ToastProvider = (props) => {
  const state2 = (0, import_react78.useSyncExternalStore)(
...
//# sourceMappingURL=chunk-WJGKA4VT.js.map
